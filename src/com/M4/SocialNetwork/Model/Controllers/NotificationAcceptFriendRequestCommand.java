...
public class NotificationAcceptFriendRequestCommand extends NotificationCommand{
	...
	public String getNotification(Notification notification) {
		 ...
		 try {
			...
			Pair<String, FriendRequest> NotificationString = new Pair<String, FriendRequest>("ConfirmFriendRequest" , friendRequest) ;
